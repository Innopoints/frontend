export default [
  {
    ...
    activities: [
      ...
      },
      {
        name: 'Video Editing',
        description:
          'You will have to manage editing of 50GB of video materials to produce a 1-minute video for InnoStudents insta',
        reward: 7000,
        worktime: null,
        isFixed: true,
      ...
      },
      {
        name: 'Toilet pointer',
        description:
          "You're a volunteer now. Stand in the hall and point visitors to a toilet",
        reward: 70,
        worktime: 24,
        isFixed: false,
